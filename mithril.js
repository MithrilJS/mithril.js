...
module.exports.delayedRemoval = delayedRemoval0
module.exports.domFor = function *domFor1({dom, domSize0}, {generation0} = {}) {
	if(dom == null)
		return
	if (domSize0 == null) {
...
var _11 = function($window) {
	...
	function moveNode(parent, vnode3, nextSibling) {
		if (vnode3.dom != null) {
			var target
	...
	function removeNode(parent, vnode3) {
		...
		if (!mask) {
			onremove(vnode3)
			removeDOM(parent, vnode3, undefined)
		} else {
