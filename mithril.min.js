...
c.children;c.dom=g.firstChild;c.domSize=g.childNodes.length;c=A.createDocumentFragment();for(var a;a=g.firstChild;)c.appendChild(a);return c}function n(c,a,e,d,f,m){if(a!==e&&(null!=a||null!=e))if(null==a)b(c,e,0,e.length,d,f,void 0);else if(null==e)p(a,0,a.length,e);else{var g;a:{if(null!=a.pool&&Math.abs(a.pool.length-e.length)<=Math.abs(a.length-e.length)&&(g=e[0]&&e[0].children&&e[0].children.length||0,Math.abs((a.pool[0]&&a.pool[0].children&&a.pool[0].children.length||0)-g)<=Math.abs((a[0]&&
a[0].children&&a[0].children.length||0)-g))){g=!0;break a}g=!1}g&&(a=a.concat(a.pool));if(a.length===e.length&&null!=e[0]&&null==e[0].key)for(var u=0;u<a.length;u++)a[u]===e[u]||null==a[u]&&null==e[u]||(null==a[u]?r(c,k(e[u],d,m),q(a,u+1,f)):null==e[u]?p(a,u,u+1,e):h(c,a[u],e[u],d,q(a,u+1,f),g,m),g&&a[u].tag===e[u].tag&&r(c,v(a[u]),q(a,u+1,f)));else{for(var n=u=0,w=a.length-1,B=e.length-1,x;w>=u&&B>=n;){var z=a[u],l=e[n];if(z!==l||g)if(null!=z&&null!=l&&z.key===l.key)u++,n++,h(c,z,l,d,q(a,u,f),g,
m),g&&z.tag===l.tag&&r(c,v(z),f);else if(z=a[w],z!==l||g)if(null!=z&&null!=l&&z.key===l.key)h(c,z,l,d,q(a,w+1,f),g,m),(g||n<B)&&r(c,v(z),q(a,u,f)),w--,n++;else break;else w--,n++;else u++,n++}for(;w>=u&&B>=n;){z=a[w];l=e[B];if(z!==l||g)if(null!=z&&null!=l&&z.key===l.key)h(c,z,l,d,q(a,w+1,f),g,m),g&&z.tag===l.tag&&r(c,v(z),f),null!=z.dom&&(f=z.dom),w--;else{if(!x){x=a;var z=w,D={},t;for(t=0;t<z;t++){var y=x[t];null!=y&&(y=y.key,null!=y&&(D[y]=t))}x=D}null!=l&&(z=x[l.key],null!=z?(D=a[z],h(c,D,l,d,
q(a,w+1,f),g,m),r(c,v(D),f),a[z].skip=!0,null!=D.dom&&(f=D.dom)):(l=k(l,d,void 0),r(c,l,f),f=l))}else w--;B--;if(B<n)break}b(c,e,n,B+1,d,f,m);p(a,u,w+1,e)}}}function h(a,g,e,b,p,w,x){var c=g.tag;if(c===e.tag){e.state=g.state;e.events=g.events;var u;var B;null!=e.attrs&&"function"===typeof e.attrs.onbeforeupdate&&(u=e.attrs.onbeforeupdate.call(e.state,e,g));"string"!==typeof e.tag&&"function"===typeof e.tag.onbeforeupdate&&(B=e.tag.onbeforeupdate.call(e.state,e,g));void 0===u&&void 0===B||u||B?u=!1:
...
a.insertBefore(g,e):a.appendChild(g)}function y(a){var c=a.children;if(null!=c&&1===c.length&&"<"===c[0].tag)c=c[0].children,a.dom.innerHTML!==c&&(a.dom.innerHTML=c);else if(null!=c||null!=a.text)throw Error("Child node of a contenteditable must be trusted");}function p(a,g,e,b){for(;g<e;g++){var c=a[g];null!=c&&(c.skip?c.skip=!1:f(c,b))}}function w(a){var c=!1;return function(){c||(c=!0,a())}}function f(a,g){function c(){if(++f===b&&(x(a),a.dom)){var c=a.domSize||1;if(1<c)for(var e=a.dom;--c;){var d=
e.nextSibling,h=d.parentNode;null!=h&&h.removeChild(d)}c=a.dom;e=c.parentNode;null!=e&&e.removeChild(c);if(c=null!=g&&null==a.domSize)c=a.attrs,c=!(null!=c&&(c.oncreate||c.onupdate||c.onbeforeremove||c.onremove));c&&"string"===typeof a.tag&&(g.pool?g.pool.push(a):g.pool=[a])}}var b=1,f=0;a.attrs&&a.attrs.onbeforeremove&&(b++,a.attrs.onbeforeremove.call(a.state,a,w(c)));"string"!==typeof a.tag&&a.tag.onbeforeremove&&(b++,a.tag.onbeforeremove.call(a.state,a,w(c)));c()}function x(a){a.attrs&&a.attrs.onremove&&
a.attrs.onremove.call(a.state,a);"string"!==typeof a.tag&&a.tag.onremove&&a.tag.onremove.call(a.state,a);if(null!=a.instance)x(a.instance);else if(a=a.children,a instanceof Array)for(var c=0;c<a.length;c++){var e=a[c];null!=e&&x(e)}}function m(a,g,e,b,f){var c=a.dom;if("key"!==g&&(e!==b||"value"===g||"checked"===g||"selectedIndex"===g||"selected"===g&&a.dom===A.activeElement||"object"===typeof b)&&"undefined"!==typeof b&&!K(g)){var d=g.indexOf(":");if(-1<d&&"xlink"===g.substr(0,d))c.setAttributeNS("http://www.w3.org/1999/xlink",
g.slice(d+1),b);else if("o"===g[0]&&"n"===g[1]&&"function"===typeof b)E(a,g,b);else if("style"===g)if(a=e,a===b&&(c.style.cssText="",a=null),null==b)c.style.cssText="";else if("string"===typeof b)c.style.cssText=b;else{"string"===typeof a&&(c.style.cssText="");for(var h in b)c.style[h]=b[h];if(null!=a&&"string"!==typeof a)for(h in a)h in b||(c.style[h]="")}else g in c&&"href"!==g&&"list"!==g&&"form"!==g&&"width"!==g&&"height"!==g&&void 0===f?"input"===a.tag&&"value"===g&&a.dom.value===b&&a.dom===
A.activeElement||"option"===a.tag&&"value"===g&&a.dom.value===b||(c[g]=b):"boolean"===typeof b?b?c.setAttribute(g,""):c.removeAttribute(g):c.setAttribute("className"===g?"class":g,b)}}function K(a){return"oninit"===a||"oncreate"===a||"onupdate"===a||"onremove"===a||"onbeforeremove"===a||"onbeforeupdate"===a}function E(a,b,e){var c=a.dom,g=function(a){var b=e.call(c,a);"function"===typeof C&&C.call(c,a);return b};if(b in c)c[b]="function"===typeof e?g:null;else{var f=b.slice(2);void 0===a.events&&
(a.events={});null!=a.events[b]&&c.removeEventListener(f,a.events[b],!1);"function"===typeof e&&(a.events[b]=g,c.addEventListener(f,a.events[b],!1))}}function t(a,b,e){"function"===typeof a.oninit&&a.oninit.call(b.state,b);"function"===typeof a.oncreate&&e.push(a.oncreate.bind(b.state,b))}function L(a,b,e,f){f?t(a,b,e):"function"===typeof a.onupdate&&e.push(a.onupdate.bind(b.state,b))}function O(a,b){Object.keys(b).forEach(function(c){a[c]=b[c]})}var A=a.document,F=A.createDocumentFragment(),C;return{render:function(a,
b){if(!a)throw Error("Ensure the DOM element being passed to m.route/m.mount/m.render is not undefined.");var c=[],f=A.activeElement;null==a.vnodes&&(a.textContent="");b instanceof Array||(b=[b]);n(a,a.vnodes,l.normalizeChildren(b),c,null,void 0);a.vnodes=b;for(var d=0;d<c.length;d++)c[d]();A.activeElement!==f&&f.focus()},setEventCallback:function(a){return C=a}}}(window),P=function(a){var b=0,k=null,d="function"===typeof requestAnimationFrame?requestAnimationFrame:setTimeout;return function(n){var h=
...
k[h]&&(k[h]=0),h=k[h]++);null==q[h]&&(q[h]=p?n:t?[]:{});q=q[h]}}return b},R=function(a){function b(b){var d=a.location[b].replace(/(?:%[a-f89][a-f0-9])+/gim,decodeURIComponent);"pathname"===b&&"/"!==d[0]&&(d="/"+d);return d}function k(a){return function(){null==t&&(t=q(function(){t=null;a()}))}}function d(a,b,f){var d=a.indexOf("?"),h=a.indexOf("#"),k=-1<d?d:-1<h?h:a.length;if(-1<d){var d=J(a.slice(d+1,-1<h?h:a.length)),p;for(p in d)b[p]=d[p]}if(-1<h)for(p in b=J(a.slice(h+1)),b)f[p]=b[p];return a.slice(0,
