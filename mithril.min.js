...
!1;var l,t;k=c.className||c["class"];if(!O(f.attrs)&&!O(c)){g={};for(var b in c)E.call(c,b)&&(g[b]=c[b]);c=g}for(b in f.attrs)E.call(f.attrs,b)&&(c[b]=f.attrs[b]);void 0!==k&&(void 0!==c["class"]&&(c["class"]=void 0,c.className=k),null!=f.attrs.className&&(c.className=f.attrs.className+" "+k));for(b in c)if(E.call(c,b)&&"key"!==b){n=!0;break}Array.isArray(e)&&1===e.length&&null!=e[0]&&"#"===e[0].tag?t=e[0].children:l=e;return w(f.tag,c.key,n?c:void 0,l,t)}return w(a,c.key,c,e)}function T(a){var c=
...
P={},E={}.hasOwnProperty;z.trust=function(a){null==a&&(a="");return w("<",void 0,void 0,a,void 0,void 0)};z.fragment=function(a,c){return w("[",a.key,a,w.normalizeChildren(c),void 0,void 0)};var r=function(a){function c(a,b){return function B(c){var g;try{if(!b||null==c||"object"!==typeof c&&"function"!==typeof c||"function"!==typeof(g=c.then))l(function(){b||0!==a.length||console.error("Possible unhandled promise rejection:",c);for(var e=0;e<a.length;e++)a[e](c);n.length=0;k.length=0;m.state=b;m.retry=
function(){B(c)}});else{if(c===f)throw new TypeError("Promise can't be resolved w/ itself");e(g.bind(c))}}catch(H){q(H)}}}function e(a){function b(b){return function(a){0<c++||b(a)}}var c=0,m=b(q);try{a(b(g),m)}catch(B){m(B)}}if(!(this instanceof r))throw Error("Promise must be called with `new`");if("function"!==typeof a)throw new TypeError("executor must be a function");var f=this,n=[],k=[],g=c(n,!0),q=c(k,!1),m=f._instance={resolvers:n,rejectors:k},l="function"===typeof setImmediate?setImmediate:
...
d){if(h.state!==d)throw Error("`vnode.state` must not be modified");}function e(h){var d=h.state;try{return this.apply(d,arguments)}finally{c(h,d)}}function f(h,d,b,a,c,e,f){for(;b<a;b++){var u=d[b];null!=u&&n(h,u,c,f,e)}}function n(h,d,u,a,c){var e=d.tag;if("string"===typeof e)switch(d.state={},null!=d.attrs&&J(d.attrs,d,u),e){case "#":return d.dom=A.createTextNode(d.children),b(h,d.dom,c),d.dom;case "<":return k(h,d,c);case "[":var m=A.createDocumentFragment();null!=d.children&&(e=d.children,f(m,
e,0,e.length,u,null,a));d.dom=m.firstChild;d.domSize=m.childNodes.length;b(h,m,c);return m;default:var p=d.tag,l=(e=d.attrs)&&e.is;p=(a=d.attrs&&d.attrs.xmlns||G[d.tag]||a)?l?A.createElementNS(a,p,{is:l}):A.createElementNS(a,p):l?A.createElement(p,{is:l}):A.createElement(p);d.dom=p;if(null!=e)for(m in l=a,e)H(d,m,null,e[m],l);b(h,p,c);null!=d.attrs&&null!=d.attrs.contenteditable?v(d):(null!=d.text&&(""!==d.text?p.textContent=d.text:d.children=[w("#",void 0,void 0,d.text,void 0,void 0)]),null!=d.children&&
(h=d.children,f(p,h,0,h.length,u,null,a),h=d.attrs,"select"===d.tag&&null!=h&&("value"in h&&H(d,"value",null,h.value,void 0),"selectedIndex"in h&&H(d,"selectedIndex",null,h.selectedIndex,void 0))));return p}else return g(d,u),null!=d.instance?(u=n(h,d.instance,u,a,c),d.dom=d.instance.dom,d.domSize=null!=d.dom?d.instance.domSize:0,b(h,u,c),d=u):(d.domSize=0,d=E),d}function k(h,d,u){var a={caption:"table",thead:"table",tbody:"table",tfoot:"table",tr:"tbody",th:"tr",td:"tr",colgroup:"table",col:"colgroup"}[(d.children.match(/^\s*?<(\w+)/im)||
[])[1]]||"div";a=A.createElement(a);a.innerHTML=d.children;d.dom=a.firstChild;d.domSize=a.childNodes.length;d=A.createDocumentFragment();for(var c;c=a.firstChild;)d.appendChild(c);b(h,d,u);return d}function g(h,d){if("function"===typeof h.tag.view){h.state=Object.create(h.tag);var b=h.state.view;if(null!=b.$$reentrantLock$$)return E;b.$$reentrantLock$$=!0}else{h.state=void 0;b=h.tag;if(null!=b.$$reentrantLock$$)return E;b.$$reentrantLock$$=!0;h.state=null!=h.tag.prototype&&"function"===typeof h.tag.prototype.view?
new h.tag(h):h.tag(h)}null!=h.attrs&&J(h.attrs,h,d);J(h.state,h,d);h.instance=w.normalize(e.call(h.state.view,h));if(h.instance===h)throw Error("A view cannot return the vnode it received as argument");b.$$reentrantLock$$=null}function q(h,d,a,c,e,g,k){if(d!==a&&(null!=d||null!=a))if(null==d)f(h,a,0,a.length,e,g,k);else if(null==a)y(d,0,d.length,a);else{if(d.length===a.length){for(var u=!1,p=0;p<a.length;p++)if(null!=a[p]&&null!=d[p]){u=null==a[p].key&&null==d[p].key;break}if(u){for(p=0;p<d.length;p++)d[p]!==
a[p]&&(null==d[p]&&null!=a[p]?n(h,a[p],e,k,t(d,p+1,g)):null==a[p]?y(d,p,p+1,a):m(h,d[p],a[p],e,t(d,p+1,g),c,k));return}}if(!c)a:{if(null!=d.pool&&Math.abs(d.pool.length-a.length)<=Math.abs(d.length-a.length)&&(c=a[0]&&a[0].children&&a[0].children.length||0,Math.abs((d.pool[0]&&d.pool[0].children&&d.pool[0].children.length||0)-c)<=Math.abs((d[0]&&d[0].children&&d[0].children.length||0)-c))){c=!0;break a}c=!1}if(c){var q=d.pool;d=d.concat(d.pool)}p=u=0;for(var v=d.length-1,D=a.length-1,I;v>=u&&D>=p;){var x=
d[u],r=a[p];if(x!==r||c)if(null==x)u++;else if(null==r)p++;else if(x.key===r.key){var C=null!=q&&u>=d.length-q.length||null==q&&c;u++;p++;m(h,x,r,e,t(d,u,g),C,k);c&&x.tag===r.tag&&b(h,l(x),g)}else if(x=d[v],x!==r||c)if(null==x)v--;else if(null==r)p++;else if(x.key===r.key)C=null!=q&&v>=d.length-q.length||null==q&&c,m(h,x,r,e,t(d,v+1,g),C,k),(c||p<D)&&b(h,l(x),t(d,u,g)),v--,p++;else break;else v--,p++;else u++,p++}for(;v>=u&&D>=p;){x=d[v];r=a[D];if(x!==r||c)if(null==x)v--;else{if(null!=r)if(x.key===
r.key)C=null!=q&&v>=d.length-q.length||null==q&&c,m(h,x,r,e,t(d,v+1,g),C,k),c&&x.tag===r.tag&&b(h,l(x),g),null!=x.dom&&(g=x.dom),v--;else{if(!I){I=d;x=v;C={};var w;for(w=0;w<x;w++){var B=I[w];null!=B&&(B=B.key,null!=B&&(C[B]=w))}I=C}null!=r&&(x=I[r.key],null!=x?(C=d[x],m(h,C,r,e,t(d,v+1,g),c,k),b(h,l(C),g),d[x].skip=!0,null!=C.dom&&(g=C.dom)):g=n(h,r,e,k,g))}D--}else v--,D--;if(D<p)break}f(h,a,p,D+1,e,g,k);y(d,u,v+1,a)}}function m(h,d,a,b,c,f,t){var p=d.tag;if(p===a.tag){a.state=d.state;a.events=
d.events;var u;if(u=!f){var r,D;null!=a.attrs&&"function"===typeof a.attrs.onbeforeupdate&&(r=e.call(a.attrs.onbeforeupdate,a,d));"string"!==typeof a.tag&&"function"===typeof a.state.onbeforeupdate&&(D=e.call(a.state.onbeforeupdate,a,d));void 0===r&&void 0===D||r||D?u=!1:(a.dom=d.dom,a.domSize=d.domSize,a.instance=d.instance,u=!0)}if(!u)if("string"===typeof p)switch(null!=a.attrs&&(f?(a.state={},J(a.attrs,a,b)):L(a.attrs,a,b)),p){case "#":d.children.toString()!==a.children.toString()&&(d.dom.nodeValue=
a.children);a.dom=d.dom;break;case "<":d.children!==a.children?(l(d),k(h,a,c)):(a.dom=d.dom,a.domSize=d.domSize);break;case "[":q(h,d.children,a.children,f,b,c,t);d=0;b=a.children;a.dom=null;if(null!=b){for(f=0;f<b.length;f++){var y=b[f];null!=y&&null!=y.dom&&(null==a.dom&&(a.dom=y.dom),d+=y.domSize||1)}1!==d&&(a.domSize=d)}break;default:h=a.dom=d.dom;t=a.attrs&&a.attrs.xmlns||G[a.tag]||t;"textarea"===a.tag&&(null==a.attrs&&(a.attrs={}),null!=a.text&&(a.attrs.value=a.text,a.text=void 0));c=d.attrs;
p=a.attrs;u=t;if(null!=p)for(y in p)H(a,y,c&&c[y],p[y],u);if(null!=c)for(y in c)null!=p&&y in p||("className"===y&&(y="class"),"o"!==y[0]||"n"!==y[1]||z(y)?"key"!==y&&a.dom.removeAttribute(y):Q(a,y,void 0));null!=a.attrs&&null!=a.attrs.contenteditable?v(a):null!=d.text&&null!=a.text&&""!==a.text?d.text.toString()!==a.text.toString()&&(d.dom.firstChild.nodeValue=a.text):(null!=d.text&&(d.children=[w("#",void 0,void 0,d.text,void 0,d.dom.firstChild)]),null!=a.text&&(a.children=[w("#",void 0,void 0,
a.text,void 0,void 0)]),q(h,d.children,a.children,f,b,null,t))}else{if(f)g(a,b);else{a.instance=w.normalize(e.call(a.state.view,a));if(a.instance===a)throw Error("A view cannot return the vnode it received as argument");null!=a.attrs&&L(a.attrs,a,b);L(a.state,a,b)}null!=a.instance?(null==d.instance?n(h,a.instance,b,t,c):m(h,d.instance,a.instance,b,c,f,t),a.dom=a.instance.dom,a.domSize=a.instance.domSize):null!=d.instance?(B(d.instance,null),a.dom=void 0,a.domSize=0):(a.dom=d.dom,a.domSize=d.domSize)}}else B(d,
null),n(h,a,b,t,c)}function l(a){var d=a.domSize;if(null!=d||null==a.dom){var b=A.createDocumentFragment();if(0<d){for(a=a.dom;--d;)b.appendChild(a.nextSibling);b.insertBefore(a,b.firstChild)}return b}return a.dom}function t(a,d,b){for(;d<a.length;d++)if(null!=a[d]&&null!=a[d].dom)return a[d].dom;return b}function b(a,d,b){b&&b.parentNode?a.insertBefore(d,b):a.appendChild(d)}function v(a){var d=a.children;if(null!=d&&1===d.length&&"<"===d[0].tag)d=d[0].children,a.dom.innerHTML!==d&&(a.dom.innerHTML=
d);else if(null!=a.text||null!=d&&0!==d.length)throw Error("Child node of a contenteditable must be trusted");}function y(a,d,b,c){for(;d<b;d++){var h=a[d];null!=h&&(h.skip?h.skip=!1:B(h,c))}}function B(a,d){function b(){if(++f===h&&(c(a,m),r(a),a.dom)){var b=a.domSize||1;if(1<b)for(var e=a.dom;--b;){var g=e.nextSibling,p=g.parentNode;null!=p&&p.removeChild(g)}b=a.dom;e=b.parentNode;null!=e&&e.removeChild(b);if(b=null!=d&&null==a.domSize)b=a.attrs,b=!(null!=b&&(b.oncreate||b.onupdate||b.onbeforeremove||
...
b){h=""+e;if(("input"===a.tag||"textarea"===a.tag)&&a.dom.value===h&&a.dom===A.activeElement)return;if("select"===a.tag)if(null===e){if(-1===a.dom.selectedIndex&&a.dom===A.activeElement)return}else if(null!==c&&a.dom.value===h&&a.dom===A.activeElement)return;if("option"===a.tag&&null!=c&&a.dom.value===h)return}"input"===a.tag&&"type"===b?d.setAttribute(b,e):d[b]=e}else"boolean"===typeof e?e?d.setAttribute(b,""):d.removeAttribute(b):d.setAttribute("className"===b?"class":b,e)}}}function z(a){return"oninit"===
...
c)}function J(a,b,c){"function"===typeof a.oninit&&e.call(a.oninit,b);"function"===typeof a.oncreate&&c.push(e.bind(a.oncreate,b))}function L(a,b,c){"function"===typeof a.onupdate&&c.push(e.bind(a.onupdate,b))}var A=a.document,E=A.createDocumentFragment(),G={svg:"http://www.w3.org/2000/svg",math:"http://www.w3.org/1998/Math/MathML"},F;K.prototype=Object.create(null);K.prototype.handleEvent=function(a){var b=this["on"+a.type];"function"===typeof b?b.call(a.target,a):"function"===typeof b.handleEvent&&
b.handleEvent(a);"function"===typeof F&&F.call(a.target,a)};return{render:function(a,b){if(!a)throw Error("Ensure the DOM element being passed to m.route/m.mount/m.render is not undefined.");var d=[],c=A.activeElement,e=a.namespaceURI;null==a.vnodes&&(a.textContent="");Array.isArray(b)||(b=[b]);q(a,a.vnodes,w.normalizeChildren(b),!1,d,null,"http://www.w3.org/1999/xhtml"===e?void 0:e);a.vnodes=b;null!=c&&A.activeElement!==c&&c.focus();for(c=0;c<d.length;c++)d[c]()},setEventCallback:function(a){return F=
a}}},F=function(a,c){function e(a){a=k.indexOf(a);-1<a&&k.splice(a,2)}function f(){if(g)throw Error("Nested m.redraw.sync() call");g=!0;for(var a=1;a<k.length;a+=2)try{k[a]()}catch(l){"undefined"!==typeof console&&console.error(l)}g=!1}var n=R(a);n.setEventCallback(function(a){!1===a.redraw?a.redraw=void 0:q()});var k=[],g=!1,q=(c||T)(f);q.sync=f;return{subscribe:function(a,c){e(a);k.push(a,c)},unsubscribe:e,redraw:q,render:n.render}}(window);M.setCompletionCallback(F.redraw);z.mount=function(a){return function(c,
e){if(null===e)a.render(c,[]),a.unsubscribe(c);else{if(null==e.view&&"function"!==typeof e)throw Error("m.mount(element, component) expects a component, not a vnode");var f=function(){a.render(c,w(e))};a.subscribe(c,f);f()}}}(F);var X=r,N=function(a){if(""===a||null==a)return{};"?"===a.charAt(0)&&(a=a.slice(1));a=a.split("&");for(var c={},e={},f=0;f<a.length;f++){var n=a[f].split("="),k=decodeURIComponent(n[0]);n=2===n.length?decodeURIComponent(n[1]):"";"true"===n?n=!0:"false"===n&&(n=!1);var g=k.split(/\]\[?|\[/),
