...
"http://www.w3.org/2000/svg";break;case "math":f="http://www.w3.org/1998/Math/MathML"}var k=(g=a.attrs)&&g.is,h=f?k?x.createElementNS(f,h,k):x.createElementNS(f,h):k?x.createElement(h,k):x.createElement(h);a.dom=h;if(null!=g)for(p in k=f,g)A(a,p,null,g[p],k);null!=a.text&&(""!==a.text?h.textContent=a.text:a.children=[u("#",void 0,void 0,a.text,void 0,void 0)]);null!=a.children&&(p=a.children,b(h,p,0,p.length,c,null,f),c=a.attrs,"select"===a.tag&&null!=c&&("value"in c&&A(a,"value",null,c.value,void 0),
"selectedIndex"in c&&A(a,"selectedIndex",null,c.selectedIndex,void 0)));return h}else return a.state=C(a.tag),n(a.tag,a,c),a.instance=u.normalize(a.tag.view.call(a.state,a)),null!=a.instance?(c=d(a.instance,c,f),a.dom=a.instance.dom,a.domSize=null!=a.dom?a.instance.domSize:0,a=c):(a.domSize=0,a=la),a}function e(a){var c={caption:"table",thead:"table",tbody:"table",tfoot:"table",tr:"tbody",th:"tr",td:"tr",colgroup:"table",col:"colgroup"}[(a.children.match(/^\s*?<(\w+)/im)||[])[1]]||"div",c=x.createElement(c);
c.innerHTML=a.children;a.dom=c.firstChild;a.domSize=c.childNodes.length;a=x.createDocumentFragment();for(var f;f=c.firstChild;)a.appendChild(f);return a}function k(a,c,f,e,h,k){if(c!==f&&(null!=c||null!=f))if(null==c)b(a,f,0,f.length,e,h,void 0);else if(null==f)p(a,c,0,c.length,f);else{var z;a:{if(null!=c.pool&&Math.abs(c.pool.length-f.length)<=Math.abs(c.length-f.length)&&(z=f[0]&&f[0].children&&f[0].children.length||0,Math.abs((c.pool[0]&&c.pool[0].children&&c.pool[0].children.length||0)-z)<=Math.abs((c[0]&&
c[0].children&&c[0].children.length||0)-z))){z=!0;break a}z=!1}z&&(c=c.concat(c.pool));if(c.length===f.length&&null!=f[0]&&null==f[0].key)for(var r=0;r<c.length;r++)c[r]===f[r]||null==c[r]&&null==f[r]||(null==c[r]?g(a,d(f[r],e,k),m(c,r+1,h)):null==f[r]?p(a,c,r,r+1,f):q(a,c[r],f[r],e,m(c,r+1,h),z,k),z&&c[r].tag===f[r].tag&&g(a,l(c[r]),m(c,r+1,h)));else{for(var A=r=0,v=c.length-1,B=f.length-1,u;v>=r&&B>=A;){var t=c[r],w=f[A];if(t===w)r++,A++;else if(null!=t&&null!=w&&t.key===w.key)r++,A++,q(a,t,w,e,
m(c,r,h),z,k),z&&t.tag===w.tag&&g(a,l(t),h);else if(t=c[v],t===w)v--,A++;else if(null!=t&&null!=w&&t.key===w.key)q(a,t,w,e,m(c,v+1,h),z,k),g(a,l(t),m(c,r,h)),v--,A++;else break}for(;v>=r&&B>=A;){t=c[v];w=f[B];if(t===w)v--;else if(null!=t&&null!=w&&t.key===w.key)q(a,t,w,e,m(c,v+1,h),z,k),z&&t.tag===w.tag&&g(a,l(t),h),null!=t.dom&&(h=t.dom),v--;else{if(!u){u=c;var t=v,n={},x;for(x=0;x<t;x++){var y=u[x];null!=y&&(y=y.key,null!=y&&(n[y]=x))}u=n}null!=w&&(t=u[w.key],null!=t?(n=c[t],q(a,n,w,e,m(c,v+1,h),
z,k),g(a,l(n),h),c[t].skip=!0,null!=n.dom&&(h=n.dom)):(w=d(w,e,void 0),g(a,w,h),h=w))}B--;if(B<A)break}b(a,f,A,B+1,e,h,k);p(a,c,r,v+1,f)}}}function q(a,c,f,b,h,p,m){var r=c.tag;if(r===f.tag){f.state=c.state;f.events=c.events;var v;var B;null!=f.attrs&&"function"===typeof f.attrs.onbeforeupdate&&(v=f.attrs.onbeforeupdate.call(f.state,f,c));"string"!==typeof f.tag&&"function"===typeof f.tag.onbeforeupdate&&(B=f.tag.onbeforeupdate.call(f.state,f,c));void 0===v&&void 0===B||v||B?v=!1:(f.dom=c.dom,f.domSize=
c.domSize,f.instance=c.instance,v=!0);if(!v)if(null!=f.attrs&&y(f.attrs,f,b,p),"string"===typeof r)switch(r){case "#":c.children.toString()!==f.children.toString()&&(c.dom.nodeValue=f.children);f.dom=c.dom;break;case "<":c.children!==f.children?(l(c),g(a,e(f),h)):(f.dom=c.dom,f.domSize=c.domSize);break;case "[":k(a,c.children,f.children,b,h,m);c=0;b=f.children;f.dom=null;if(null!=b){for(var n=0;n<b.length;n++)a=b[n],null!=a&&null!=a.dom&&(null==f.dom&&(f.dom=a.dom),c+=a.domSize||1);1!==c&&(f.domSize=
c)}break;default:a=m;h=f.dom=c.dom;switch(f.tag){case "svg":a="http://www.w3.org/2000/svg";break;case "math":a="http://www.w3.org/1998/Math/MathML"}"textarea"===f.tag&&(null==f.attrs&&(f.attrs={}),null!=f.text&&(f.attrs.value=f.text));p=c.attrs;m=f.attrs;r=a;if(null!=m)for(n in m)A(f,n,p&&p[n],m[n],r);if(null!=p)for(n in p)null!=m&&n in m||"key"!==n&&f.dom.removeAttribute(n);null!=c.text&&null!=f.text&&""!==f.text?c.text.toString()!==f.text.toString()&&(c.dom.firstChild.nodeValue=f.text):(null!=c.text&&
(c.children=[u("#",void 0,void 0,c.text,void 0,c.dom.firstChild)]),null!=f.text&&(f.children=[u("#",void 0,void 0,f.text,void 0,void 0)]),k(h,c.children,f.children,b,null,a))}else f.instance=u.normalize(f.tag.view.call(f.state,f)),y(f.tag,f,b,p),null!=f.instance?(null==c.instance?g(a,d(f.instance,b,m),h):q(a,c.instance,f.instance,b,h,p,m),f.dom=f.instance.dom,f.domSize=f.instance.domSize):null!=c.instance?(z(a,c.instance,null,!1),f.dom=void 0,f.domSize=0):(f.dom=c.dom,f.domSize=c.domSize)}else z(a,
...
G=function(){var a=[];return{subscribe:a.push.bind(a),unsubscribe:function(b){b=a.indexOf(b);-1<b&&a.splice(b,1)},publish:function(){for(var b=0;b<a.length;b++)a[b].apply(this,arguments)}}}();N.setCompletionCallback(G.publish);var Z=function(a){if(""===a||null==a)return{};"?"===a.charAt(0)&&(a=a.slice(1));a=a.split("&");for(var b={},d={},e=0;e<a.length;e++){var k=a[e].split("="),q=decodeURIComponent(k[0]),k=2===k.length?decodeURIComponent(k[1]):"",l=Number(k);""!==k&&!isNaN(l)||"NaN"===k?k=l:"true"===
k?k=!0:"false"===k?k=!1:(l=new Date(k),isNaN(l.getTime())||(k=l));var l=q.split(/\]\[?|\[/),m=b;-1<q.indexOf("[")&&l.pop();for(var g=0;g<l.length;g++){var q=l[g],p=l[g+1],p=""==p||!isNaN(parseInt(p,10)),n=g===l.length-1;""===q&&(q=l.slice(0,g).join(),null==d[q]&&(d[q]=0),q=d[q]++);null==m[q]&&(m[q]=n?k:p?[]:{});m=m[q]}}return b},ma=function(a){function b(b){var d=a.location[b].replace(/(?:%[a-f89][a-f0-9])+/gim,decodeURIComponent);"pathname"===b&&"/"!==d[0]&&(d="/"+d);return d}function d(a,b,d){var e=
...
"(.*?)").replace(/:[^\/]+/g,"([^\\/]+)")+"/?$");if(e.test(m)){m.replace(e,function(){for(var e=d.match(/:[^\/]+/g)||[],l=[].slice.call(arguments,1,-2),m=0;m<e.length;m++)h[e[m].replace(/:|\./g,"")]=decodeURIComponent(l[m]);k(b[d],h,a,d)});return}}n(a,h)})}q?a.onpopstate=h:"#"===m.charAt(0)&&(a.onhashchange=h);h();return h},link:function(a){a.dom.setAttribute("href",m+a.attrs.href);a.dom.onclick=function(b){b.preventDefault();b.redraw=!1;k(a.attrs.href,void 0,void 0)}}}},na=function(a){var b=0,d=null,
e="function"===typeof requestAnimationFrame?requestAnimationFrame:setTimeout;return function(k){var n=Date.now();!0===k||0===b||16<=n-b?(b=n,a()):null===d&&(d=e(function(){d=null;a();b=Date.now()},16-(n-b)))}},aa=function(a,b,d,e){e=na(e);null!=b&&b.setEventCallback(function(a){!1!==a.redraw&&d.publish()});null!=d&&(a.redraw&&d.unsubscribe(a.redraw),d.subscribe(e));return a.redraw=e};n.route=function(a,b,d){var e=ma(a);a=function(a,n,l){var m=null,g=null;l=e.defineRoutes(l,function(d,e,h,l){if("function"!==
typeof d.view){"function"!==typeof d.render&&(d.render=function(a){return a});var n=function(l){m=h;g=l;b.render(a,d.render(u(l,null,e,void 0,void 0,void 0)))};"function"!==typeof d.resolve&&(d.resolve=function(){n(g)});h!==m?d.resolve(n,e,h,l):n(g)}else b.render(a,u(d,null,e,void 0,void 0,void 0))},function(){e.setPath(n,null,{replace:!0})});aa(a,b,d,l)};a.link=e.link;a.prefix=e.setPrefix;a.set=e.setPath;a.get=e.getPath;return a}(window,L,G);var oa={view:function(){}};n.mount=function(a,b){return function(d,
e){b.unsubscribe(d.redraw);aa(d,a,b,function(){a.render(d,u(null===e?oa:e,void 0,void 0,void 0,void 0,void 0))})();null===e&&(b.unsubscribe(d.redraw),delete d.redraw)}}(L,G);n.trust=function(a){return u("<",void 0,void 0,a,void 0,void 0)};n.withAttr=function(a,b,d){return function(e){return b.call(d||this,a in e.currentTarget?e.currentTarget[a]:e.currentTarget.getAttribute(a))}};n.prop=C.stream;n.prop.combine=C.combine;n.prop.reject=C.reject;n.prop.merge=C.merge;n.prop.HALT=C.HALT;n.render=L.render;
n.redraw=G.publish;n.request=N.xhr;n.jsonp=N.jsonp;n.version="1.0.0";"undefined"!==typeof module?module.exports=n:window.m=n};