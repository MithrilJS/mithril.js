...
"["===d[3][0]&&((r=d[6])&&(r=r.replace(/\\(["'])/g,"$1").replace(/\\\\/g,"\\")),"class"===d[4]?m.push(r):k[d[4]]=r||!0)}0<m.length&&(k.className=m.join(" "));d=M[b]={tag:h,attrs:k}}if(null==e)e={};else if("object"!==typeof e||null!=e.tag||Array.isArray(e))e={},f=1;if(arguments.length===f+1)h=arguments[f],Array.isArray(h)||(h=[h]);else for(h=[];f<arguments.length;)h.push(arguments[f++]);f=z.normalizeChildren(h);if("string"===typeof b){h=!1;var l,t,m=e.className||e["class"],a;for(a in d.attrs)N.call(d.attrs,
