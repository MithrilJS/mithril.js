new function(){function t(d,e,q,g,n,h){return{tag:d,key:e,attrs:q,children:g,text:n,dom:h,domSize:void 0,state:{},events:void 0,instance:void 0,skip:!1}}function x(d){if(null==d||"string"!==typeof d&&null==d.view)throw Error("The selector must be either a string or a component.");if("string"===typeof d&&void 0===F[d]){for(var e,q,g=[],n={};e=O.exec(d);){var h=e[1],m=e[2];""===h&&""!==m?q=m:"#"===h?n.id=m:"."===h?g.push(m):"["===e[3][0]&&((h=e[6])&&(h=h.replace(/\\(["'])/g,"$1").replace(/\\\\/g,"\\")),
n[e[4]]=h||!0)}0<g.length&&(n.className=g.join(" "));F[d]=function(d,e){var c=!1,g,h,u=d.className||d["class"],m;for(m in n)d[m]=n[m];void 0!==u&&(void 0!==d["class"]&&(d["class"]=void 0,d.className=u),void 0!==n.className&&(d.className=n.className+" "+u));for(m in d)if("key"!==m){c=!0;break}e instanceof Array&&1==e.length&&null!=e[0]&&"#"===e[0].tag?h=e[0].children:g=e;return t(q||"div",d.key,c?d:void 0,g,h,void 0)}}var l;null!=arguments[1]&&("object"!==typeof arguments[1]||void 0!==arguments[1].tag||
...
function(){if(4===u.readyState){try{var d=c.extract!==h?c.extract(u,c):c.deserialize(c.extract(u,c));if(200<=u.status&&300>u.status)e(m(c.type,d));else{var g=Error(u.responseText),k;for(k in d)g[k]=d[k];e.error(g)}}catch(w){e.error(w)}"function"===typeof z&&z()}};k?u.send(c.data):u.send();return e},jsonp:function(c){var e=l();void 0!==c.initialValue&&e(c.initialValue);var k=c.callbackName||"_mithril_"+Math.round(1E16*Math.random())+"_"+w++,h=d.document.createElement("script");d[k]=function(g){h.parentNode.removeChild(h);
e(m(c.type,g));"function"===typeof z&&z();delete d[k]};h.onerror=function(){h.parentNode.removeChild(h);e.error(Error("JSONP request failed"));"function"===typeof z&&z();delete d[k]};null==c.data&&(c.data={});c.url=q(c.url,c.data);c.data[c.callbackKey||"callback"]=k;h.src=g(c.url,c.data);d.document.documentElement.appendChild(h);return e},setCompletionCallback:function(c){z=c}}}(window,console.error.bind(console)),C=function(){var d=[];return{subscribe:d.push.bind(d),unsubscribe:function(e){e=d.indexOf(e);
-1<e&&d.splice(e,1)},publish:function(){for(var e=0;e<d.length;e++)d[e].apply(this,arguments)}}}();J.setCompletionCallback(C.publish);var M=function(d){if(""===d||null==d)return{};"?"===d.charAt(0)&&(d=d.slice(1));d=d.split("&");for(var e={},q={},g=0;g<d.length;g++){var n=d[g].split("="),h=decodeURIComponent(n[0]),n=2===n.length?decodeURIComponent(n[1]):"",m=Number(n);""!==n&&!isNaN(m)||"NaN"===n?n=m:"true"===n?n=!0:"false"===n?n=!1:(m=new Date(n),isNaN(m.getTime())||(n=m));var m=h.split(/\]\[?|\[/),
l=e;-1<h.indexOf("[")&&m.pop();for(var w=0;w<m.length;w++){var h=m[w],z=m[w+1],z=""==z||!isNaN(parseInt(z,10)),c=w===m.length-1;""===h&&(h=m.slice(0,w).join(),null==q[h]&&(q[h]=0),h=q[h]++);null==l[h]&&(l[h]=c?n:z?[]:{});l=l[h]}}return e},Q=function(d){function e(e){var g=d.location[e].replace(/(?:%[a-f89][a-f0-9])+/gim,decodeURIComponent);"pathname"===e&&"/"!==g[0]&&(g="/"+g);return g}function q(d,e,c){var g=d.indexOf("?"),k=d.indexOf("#"),h=-1<g?g:-1<k?k:d.length;if(-1<g){var g=M(d.slice(g+1,-1<
k?k:d.length)),l;for(l in g)e[l]=g[l]}if(-1<k)for(l in e=M(d.slice(k+1)),e)c[l]=e[l];return d.slice(0,h)}function g(){switch(l.charAt(0)){case "#":return e("hash").slice(l.length);case "?":return e("search").slice(l.length)+e("hash");default:return e("pathname").slice(l.length)+e("search")+e("hash")}}function n(e,g,c){var n={},k={};e=q(e,n,k);if(null!=g){for(var m in g)n[m]=g[m];e=e.replace(/:([^\/]+)/g,function(c,d){delete n[d];return g[d]})}(m=E(n))&&(e+="?"+m);(k=E(k))&&(e+="#"+k);h?(c&&c.replace?
...
Date.now();!0===n||0===e||16<=h-e?(e=h,d()):null===q&&(q=g(function(){q=null;d();e=Date.now()},16-(h-e)))}},N=function(d,e,q,g){g=R(g);null!=e&&e.setEventCallback(function(d){!1!==d.redraw&&q.publish()});null!=q&&(d.redraw&&q.unsubscribe(d.redraw),q.subscribe(g));return d.redraw=g};x.route=function(d,e,q){var g=Q(d);d=function(d,h,m){var l=null,w="div";m=g.defineRoutes(m,function(g,c,h,k){c.path=h;c.route=k;if("function"===typeof g.onmatch)if("function"!==typeof g.view&&(g.view=function(c){return c}),
k=function(k){l=h;w=k;e.render(d,g.view(t(k,null,c,void 0,void 0,void 0)))},h!==l)g.onmatch(t(g,null,c,void 0,void 0,void 0),k);else k(w);else e.render(d,t(g,null,c,void 0,void 0,void 0))},function(){g.setPath(h,null,{replace:!0})});N(d,e,q,m)};d.link=g.link;d.prefix=g.setPrefix;d.set=g.setPath;d.get=g.getPath;return d}(window,H,C);x.mount=function(d,e){return function(q,g){null===g?(d.render(q,[]),e.unsubscribe(q.redraw),delete q.redraw):N(q,d,e,function(){d.render(q,t(g,void 0,void 0,void 0,void 0,
void 0))})()}}(H,C);x.withAttr=function(d,e,q){return function(g){return e.call(q||this,d in g.currentTarget?g.currentTarget[d]:g.currentTarget.getAttribute(d))}};x.prop=L(console.log.bind(console));x.render=H.render;x.redraw=C.publish;x.request=J.request;x.jsonp=J.jsonp;x.version="1.0.0";"undefined"!==typeof module?module.exports=x:window.m=x};