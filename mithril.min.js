...
typeof f)B(a,c,f);else if("style"===c)if(a=b,a===f&&(g.style="",a=null),null==f)g.style="";else if("string"===typeof f)g.style=f;else{"string"===typeof a&&(g.style="");for(var k in f)g.style[k]=f[k];if(null!=a&&"string"!==typeof a)for(k in a)k in f||(g.style[k]="")}else if(c in g&&"href"!==c&&"list"!==c&&"form"!==c&&void 0===d){if("input"!==a.tag||"value"!==c||a.dom.value!==f||a.dom!==x.activeElement)g[c]=f}else"boolean"===typeof f?f?g.setAttribute(c,""):g.removeAttribute(c):g.setAttribute("className"===
