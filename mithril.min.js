new function(){function y(){function a(){0<arguments.length&&H(a,arguments[0],void 0);return a._state.value}N(a,arguments);0<arguments.length&&H(a,arguments[0],void 0);return a}function N(a,b){a.constructor=y;a._state={id:guid++,value:void 0,error:void 0,state:0,derive:void 0,recover:void 0,deps:{},parents:[],errorStream:void 0,endStream:void 0};a.map=Z;a.ap=aa;a.of=y;a.valueOf=O;a.toJSON=ba;a.toString=O;a.run=ca;a["catch"]=da;Object.defineProperties(a,{error:{get:function(){if(!a._state.errorStream){var b=
function(){0<arguments.length&&H(a,void 0,arguments[0]);return a._state.error};N(b,[]);D(b,[a],noop,noop);a._state.errorStream=b}return a._state.errorStream}},end:{get:function(){if(!a._state.endStream){var b=y();b.map(function(e){!0===e&&(P(a),P(b));return e});a._state.endStream=b}return a._state.endStream}}})}function H(a,b,d){E(a,b,d);for(var e in a._state.deps)I(a._state.deps[e],!1);a._state.changed=!1;for(var k in a._state.deps)a._state.deps[k]._state.changed=!1}function E(a,b,d){d=Q(b,d);if(void 0!==
d&&"function"===typeof a._state.recover){if(!R(a,S,!0))return}else S(a,b,d);a._state.changed=!0;2!==a._state.state&&(a._state.state=1)}function S(a,b,d){a._state.value=b;a._state.error=d}function I(a,b){var d=a._state.parents;0<d.length&&d.filter(ea).length===d.length&&(b||0<d.filter(T).length)&&(d=d.filter(U),0<d.length?E(a,void 0,d[0]._state.error):R(a,E,!1))}function R(a,b,d){try{var e=d?a._state.recover():a._state.derive();if(e===HALT)return!1;b(a,e,void 0)}catch(k){b(a,void 0,k),fa(a,k)}return!0}
function Q(a,b){null!=a&&a.constructor===y&&(b=void 0!==a._state.error?a._state.error:Q(a._state.value,a._state.error));return b}function fa(a,b){0===Object.keys(a._state.deps).length&&null==a._state.derive&&setTimeout(function(){0===Object.keys(a._state.deps).length&&console.error(b)},0)}function ca(a){var b=y(),d=this;return D(b,[d],function(){return V(b,a(d()))},void 0)}function da(a){var b=y(),d=this;return D(b,[d],function(){return d._state.value},function(){return V(b,a(d._state.error))})}function F(a,
b){return D(y(),b,function(){var d=b.filter(U);if(0<d.length)throw d[0]._state.error;return a.apply(this,b.concat([b.filter(T)]))},void 0)}function V(a,b){if(null!=b&&b.constructor===y){var d=b,e=function(){E(a,d._state.value,d._state.error);for(var b in a._state.deps)I(a._state.deps[b],!1)};d.map(e)["catch"](function(a){e();throw a;});if(0===d._state.state)return HALT;if(d._state.error)throw d._state.error;b=d._state.value}return b}function D(a,b,d,e){var k=a._state;k.derive=d;k.recover=e;k.parents=
b.filter(ga);W(a,k.parents);I(a,!0);return a}function W(a,b){for(var d=0;d<b.length;d++)b[d]._state.deps[a._state.id]=a,W(a,b[d]._state.parents)}function P(a){for(var b=0;b<a._state.parents.length;b++)delete a._state.parents[b]._state.deps[a._state.id];for(var d in a._state.deps){var b=a._state.deps[d],e=b._state.parents.indexOf(a);-1<e&&b._state.parents.splice(e,1)}a._state.state=2;a._state.deps={}}function Z(a){return F(function(b){return a(b())},[this])}function aa(a){return F(function(a,d){return a()(d())},
[this,a])}function O(){return this._state.value}function ba(){return JSON.stringify(this._state.value)}function ea(a){return 1===a._state.state}function T(a){return a._state.changed}function ga(a){return 2!==a._state.state}function U(a){return a._state.error}function u(a,b,d,e,k,q){return{tag:a,key:b,attrs:d,children:e,text:k,dom:q,domSize:void 0,state:{},events:void 0,instance:void 0}}var C={stream:y,merge:function(a){return F(function(){return a.map(function(a){return a()})},a)},combine:F,reject:function(a){var b=
y();b.error(a);return b},HALT:HALT};u.normalize=function(a){return a instanceof Array?u("[",void 0,void 0,u.normalizeChildren(a),void 0,void 0):null!=a&&"object"!==typeof a?u("#",void 0,void 0,a,void 0,void 0):a};u.normalizeChildren=function(a){for(var b=0;b<a.length;b++)a[b]=u.normalize(a[b]);return a};var ha=/(?:(^|#|\.)([^#\.\[\]]+))|(\[(.+?)(?:\s*=\s*("|'|)((?:\\["'\]]|.)*?)\5)?\])/g,J={},n=function(a){if("string"===typeof a&&void 0===J[a]){for(var b,d,e=[],k={};b=ha.exec(a);){var q=b[1],l=b[2];
""===q&&""!==l?d=l:"#"===q?k.id=l:"."===q?e.push(l):"["===b[3][0]&&((q=b[6])&&(q=q.replace(/\\(["'])/g,"$1").replace(/\\\\/g,"\\")),k[b[4]]=q||!0)}0<e.length&&(k.className=e.join(" "));J[a]=function(a,b){var e=!1,h,q,m=a.className||a["class"],l;for(l in k)a[l]=k[l];void 0!==m&&(void 0!==a["class"]&&(a["class"]=void 0,a.className=m),void 0!==k.className&&(a.className=k.className+" "+m));for(l in a)if("key"!==l){e=!0;break}b instanceof Array&&1==b.length&&null!=b[0]&&"#"===b[0].tag?q=b[0].children:
h=b;return u(d||"div",a.key,e?a:void 0,h,q,void 0)}}var m;null!=arguments[1]&&("object"!==typeof arguments[1]||void 0!==arguments[1].tag||arguments[1]instanceof Array)?e=1:(m=arguments[1],e=2);if(arguments.length===e+1)b=arguments[e]instanceof Array?arguments[e]:[arguments[e]];else for(b=[];e<arguments.length;e++)b.push(arguments[e]);return"string"===typeof a?J[a](m||{},u.normalizeChildren(b)):u(a,m&&m.key,m||{},u.normalizeChildren(b),void 0,void 0)},K=function(a){function b(a,c,f,b,e,p,h){for(;f<
...
C(a.tag),n(a.tag,a,c),a.instance=u.normalize(a.tag.view.call(a.state,a)),null!=a.instance?(c=d(a.instance,c,f),a.dom=a.instance.dom,a.domSize=null!=a.dom?a.instance.domSize:0,a=c):(a.domSize=0,a=ia),a}function e(a){var c={caption:"table",thead:"table",tbody:"table",tfoot:"table",tr:"tbody",th:"tr",td:"tr",colgroup:"table",col:"colgroup"}[(a.children.match(/^\s*?<(\w+)/im)||[])[1]]||"div",c=x.createElement(c);c.innerHTML=a.children;a.dom=c.firstChild;a.domSize=c.childNodes.length;a=x.createDocumentFragment();
...
a.oninit.call(c.state,c);"function"===typeof a.oncreate&&b.push(a.oncreate.bind(c.state,c))}function y(a,c,b,g){g?n(a,c,b):"function"===typeof a.onupdate&&b.push(a.onupdate.bind(c.state,c))}function C(a){if(a instanceof Array){for(var c=[],b=0;b<a.length;b++)c[b]=a[b];return c}if("object"===typeof a){c={};for(b in a)c[b]=a[b];return c}return a}var x=a.document,ia=x.createDocumentFragment(),D;return{render:function(a,c){var b=[],g=x.activeElement;null==a.vnodes&&(a.vnodes=[],a.textContent="");c instanceof
Array||(c=[c]);k(a,a.vnodes,u.normalizeChildren(c),b,null,void 0);a.vnodes=c;for(var d=0;d<b.length;d++)b[d]();x.activeElement!==g&&g.focus()},setEventCallback:function(a){return D=a}}}(window),L=function(a){function b(a,e){if(e instanceof Array)for(var l=0;l<e.length;l++)b(a+"["+l+"]",e[l]);else if("[object Object]"===Object.prototype.toString.call(e))for(l in e)b(a+"["+l+"]",e[l]);else d.push(encodeURIComponent(a)+(null!=e&&""!==e?"="+encodeURIComponent(e):""))}if("[object Object]"!==Object.prototype.toString.call(a))return"";
var d=[],e;for(e in a)b(e,a[e]);return d.join("&")},M=function(a){function b(a,b){if(null==b)return a;for(var d=a.match(/:[^\/]+/gi)||[],h=0;h<d.length;h++){var e=d[h].slice(1);null!=b[e]&&(a=a.replace(d[h],b[e]),delete b[e])}return a}function d(a,b){var d=L(b);if(""!==d){var h=0>a.indexOf("?")?"?":"&";a+=h+d}return a}function e(a){try{return""!==a?JSON.parse(a):null}catch(b){throw Error(a);}}function k(a){return a.responseText}function q(a,b){if("function"===typeof a)if(b instanceof Array)for(var d=
...
0;b<a.length;b++)a[b].apply(this,arguments)}}}();M.setCompletionCallback(G.publish);var X=function(a){if(""===a||null==a)return{};"?"===a.charAt(0)&&(a=a.slice(1));a=a.split("&");for(var b={},d={},e=0;e<a.length;e++){var k=a[e].split("="),q=decodeURIComponent(k[0]),k=2===k.length?decodeURIComponent(k[1]):"",l=Number(k);""!==k&&!isNaN(l)||"NaN"===k?k=l:"true"===k?k=!0:"false"===k?k=!1:(l=new Date(k),isNaN(l.getTime())||(k=l));var l=q.split(/\]\[?|\[/),m=b;-1<q.indexOf("[")&&l.pop();for(var g=0;g<l.length;g++){var q=
l[g],p=l[g+1],p=""==p||!isNaN(parseInt(p,10)),n=g===l.length-1;""===q&&(q=l.slice(0,g).join(),null==d[q]&&(d[q]=0),q=d[q]++);null==m[q]&&(m[q]=n?k:p?[]:{});m=m[q]}}return b},ja=function(a){function b(b){var d=a.location[b].replace(/(?:%[a-f89][a-f0-9])+/gim,decodeURIComponent);"pathname"===b&&"/"!==d[0]&&(d="/"+d);return d}function d(a,b,d){var e=a.indexOf("?"),k=a.indexOf("#"),m=-1<e?e:-1<k?k:a.length;if(-1<e){var e=X(a.slice(e+1,-1<k?k:a.length)),l;for(l in e)b[l]=e[l]}if(-1<k)for(l in b=X(a.slice(k+
1)),b)d[l]=b[l];return a.slice(0,m)}function e(){switch(m.charAt(0)){case "#":return b("hash").slice(m.length);case "?":return b("search").slice(m.length)+b("hash");default:return b("pathname").slice(m.length)+b("search")+b("hash")}}function k(b,e,k){var h={},l={};b=d(b,h,l);if(null!=e){for(var n in e)h[n]=e[n];b=b.replace(/:([^\/]+)/g,function(a,b){delete h[b];return e[b]})}(n=L(h))&&(b+="?"+n);(l=L(l))&&(b+="#"+l);q?(k&&k.replace?a.history.replaceState(null,null,m+b):a.history.pushState(null,null,
...
m=0;m<e.length;m++)h[e[m].replace(/:|\./g,"")]=decodeURIComponent(l[m]);k(b[d],h,a,d)});return}}n(a,h)})}q?a.onpopstate=h:"#"===m.charAt(0)&&(a.onhashchange=h);h();return h},link:function(a){a.dom.setAttribute("href",m+a.attrs.href);a.dom.onclick=function(b){b.preventDefault();b.redraw=!1;k(a.attrs.href,void 0,void 0)}}}},ka=function(a){var b=0,d=null,e="function"===typeof requestAnimationFrame?requestAnimationFrame:setTimeout;return function(k){var n=Date.now();!0===k||0===b||16<=n-b?(b=n,a()):null===
d&&(d=e(function(){d=null;a();b=Date.now()},16-(n-b)))}},Y=function(a,b,d,e){e=ka(e);null!=b&&b.setEventCallback(function(a){!1!==a.redraw&&d.publish()});null!=d&&(a.redraw&&d.unsubscribe(a.redraw),d.subscribe(e));return a.redraw=e};n.route=function(a,b,d){var e=ja(a);a=function(a,n,l){var m=null,g=null;l=e.defineRoutes(l,function(d,e,h,l){if("function"!==typeof d.view){"function"!==typeof d.render&&(d.render=function(a){return a});var n=function(l){m=h;g=l;b.render(a,d.render(u(l,null,e,void 0,void 0,
void 0)))};"function"!==typeof d.resolve&&(d.resolve=function(){n(g)});h!==m?d.resolve(n,e,h,l):n(g)}else b.render(a,u(d,null,e,void 0,void 0,void 0))},function(){e.setPath(n,null,{replace:!0})});Y(a,b,d,l)};a.link=e.link;a.prefix=e.setPrefix;a.set=e.setPath;a.get=e.getPath;return a}(window,K,G);var la={view:function(){}};n.mount=function(a,b){return function(d,e){b.unsubscribe(d.redraw);Y(d,a,b,function(){a.render(d,u(null===e?la:e,void 0,void 0,void 0,void 0,void 0))})();null===e&&(b.unsubscribe(d.redraw),
delete d.redraw)}}(K,G);n.trust=function(a){return u("<",void 0,void 0,a,void 0,void 0)};n.withAttr=function(a,b,d){return function(e){return b.call(d||this,a in e.currentTarget?e.currentTarget[a]:e.currentTarget.getAttribute(a))}};n.prop=C.stream;n.prop.combine=C.combine;n.prop.reject=C.reject;n.prop.merge=C.merge;n.prop.HALT=C.HALT;n.render=K.render;n.redraw=G.publish;n.request=M.xhr;n.jsonp=M.jsonp;n.version="1.0.0";"undefined"!==typeof module?module.exports=n:window.m=n};