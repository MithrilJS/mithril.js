...
a._state.state}function U(a){return a._state.changed}function ha(a){return 2!==a._state.state}function V(a){return a._state.error}function r(a,b,h,d,g,k){return{tag:a,key:b,attrs:h,children:d,text:g,dom:k,domSize:void 0,state:{},events:void 0,instance:void 0}}var aa=0,P=function(){},F={},C={stream:y,merge:function(a){return G(function(){return a.map(function(a){return a()})},a)},combine:G,reject:function(a){var b=y();b.error(a);return b},HALT:F};r.normalize=function(a){return a instanceof Array?r("[",
void 0,void 0,r.normalizeChildren(a),void 0,void 0):null!=a&&"object"!==typeof a?r("#",void 0,void 0,a,void 0,void 0):a};r.normalizeChildren=function(a){for(var b=0;b<a.length;b++)a[b]=r.normalize(a[b]);return a};var ia=/(?:(^|#|\.)([^#\.\[\]]+))|(\[(.+?)(?:\s*=\s*("|'|)((?:\\["'\]]|.)*?)\5)?\])/g,J={},l=function(a){if("string"===typeof a&&void 0===J[a]){for(var b,h,d=[],g={};b=ia.exec(a);){var k=b[1],m=b[2];""===k&&""!==m?h=m:"#"===k?g.id=m:"."===k?d.push(m):"["===b[3][0]&&((k=b[6])&&(k=k.replace(/\\(["'])/g,
"$1").replace(/\\\\/g,"\\")),g[b[4]]=k||!0)}0<d.length&&(g.className=d.join(" "));J[a]=function(a,b){var e=!1,d,k,m=a.className||a["class"],t;for(t in g)a[t]=g[t];void 0!==m&&(void 0!==a["class"]&&(a["class"]=void 0,a.className=m),void 0!==g.className&&(a.className=g.className+" "+m));for(t in a)if("key"!==t){e=!0;break}b instanceof Array&&1==b.length&&null!=b[0]&&"#"===b[0].tag?k=b[0].children:d=b;return r(h||"div",a.key,e?a:void 0,d,k,void 0)}}var e;null!=arguments[1]&&("object"!==typeof arguments[1]||
void 0!==arguments[1].tag||arguments[1]instanceof Array)?d=1:(e=arguments[1],d=2);if(arguments.length===d+1)b=arguments[d]instanceof Array?arguments[d]:[arguments[d]];else for(b=[];d<arguments.length;d++)b.push(arguments[d]);return"string"===typeof a?J[a](e||{},r.normalizeChildren(b)):r(a,e&&e.key,e||{},r.normalizeChildren(b),void 0,void 0)},K=function(a){function b(a,c,f,b,e,d,g){for(;f<b;f++){var k=c[f];null!=k&&n(a,h(k,e,g),d)}}function h(a,c,f){var e=a.tag;null!=a.attrs&&l(a.attrs,a,c);if("string"===
...
a.dom=g;if(null!=e)for(n in k=f,e)A(a,n,null,e[n],k);null!=a.text&&(""!==a.text?g.textContent=a.text:a.children=[r("#",void 0,void 0,a.text,void 0,void 0)]);null!=a.children&&(n=a.children,b(g,n,0,n.length,c,null,f),c=a.attrs,"select"===a.tag&&null!=c&&("value"in c&&A(a,"value",null,c.value,void 0),"selectedIndex"in c&&A(a,"selectedIndex",null,c.selectedIndex,void 0)));return g}else return a.state=C(a.tag),l(a.tag,a,c),a.instance=r.normalize(a.tag.view.call(a.state,a)),null!=a.instance?(c=h(a.instance,
...
c[q]?n(a,h(f[q],d,B),e(c,q+1,g)):null==f[q]?v(a,c,q,q+1,f):k(a,c[q],f[q],d,e(c,q+1,g),p,B),p&&c[q].tag===f[q].tag&&n(a,m(c[q]),e(c,q+1,g))}else{for(var A=q=0,t=c.length-1,z=f.length-1,r;t>=q&&z>=A;){var u=c[q],w=f[A];if(u===w)q++,A++;else if(null!=u&&null!=w&&u.key===w.key)q++,A++,k(a,u,w,d,e(c,q,g),p,B),p&&u.tag===w.tag&&n(a,m(u),g);else if(u=c[t],u===w)t--,A++;else if(null!=u&&null!=w&&u.key===w.key)k(a,u,w,d,e(c,t+1,g),p,B),n(a,m(u),e(c,q,g)),t--,A++;else break}for(;t>=q&&z>=A;){u=c[t];w=f[z];
if(u===w)t--;else if(null!=u&&null!=w&&u.key===w.key)k(a,u,w,d,e(c,t+1,g),p,B),p&&u.tag===w.tag&&n(a,m(u),g),null!=u.dom&&(g=u.dom),t--;else{if(!r){r=c;var u=t,l={},x;for(x=0;x<u;x++){var y=r[x];null!=y&&(y=y.key,null!=y&&(l[y]=x))}r=l}null!=w&&(u=r[w.key],null!=u?(l=c[u],k(a,l,w,d,e(c,t+1,g),p,B),n(a,m(l),g),c[u].skip=!0,null!=l.dom&&(g=l.dom)):(w=h(w,d,void 0),n(a,w,g),g=w))}z--;if(z<A)break}b(a,f,A,z+1,d,g,B);v(a,c,q,t+1,f)}}}function k(a,c,f,b,e,p,v){var q=c.tag;if(q===f.tag){f.state=c.state;
f.events=c.events;var t;var z;null!=f.attrs&&"function"===typeof f.attrs.onbeforeupdate&&(t=f.attrs.onbeforeupdate.call(f.state,f,c));"string"!==typeof f.tag&&"function"===typeof f.tag.onbeforeupdate&&(z=f.tag.onbeforeupdate.call(f.state,f,c));void 0===t&&void 0===z||t||z?t=!1:(f.dom=c.dom,f.domSize=c.domSize,f.instance=c.instance,t=!0);if(!t)if(null!=f.attrs&&y(f.attrs,f,b,p),"string"===typeof q)switch(q){case "#":c.children.toString()!==f.children.toString()&&(c.dom.nodeValue=f.children);f.dom=
...
c?"class":c,e)}}function z(a){return null!=a&&(a.oncreate||a.onupdate||a.onbeforeremove||a.onremove)}function t(a,c,b){var e=a.dom,d=function(a){var c=b.call(e,a);"function"===typeof D&&D.call(e,a);return c};if(c in e)e[c]=d;else{var g=c.slice(2);void 0===a.events&&(a.events={});null!=a.events[c]&&e.removeEventListener(g,a.events[c],!1);a.events[c]=d;e.addEventListener(g,a.events[c],!1)}}function l(a,c,b){"function"===typeof a.oninit&&a.oninit.call(c.state,c);"function"===typeof a.oncreate&&b.push(a.oncreate.bind(c.state,
c))}function y(a,c,b,e){e?l(a,c,b):"function"===typeof a.onupdate&&b.push(a.onupdate.bind(c.state,c))}function C(a){if(a instanceof Array){for(var c=[],b=0;b<a.length;b++)c[b]=a[b];return c}if("object"===typeof a){c={};for(b in a)c[b]=a[b];return c}return a}var x=a.document,ja=x.createDocumentFragment(),D;return{render:function(a,c){var b=[],e=x.activeElement;null==a.vnodes&&(a.vnodes=[]);c instanceof Array||(c=[c]);g(a,a.vnodes,r.normalizeChildren(c),b,null,void 0);a.vnodes=c;for(var d=0;d<b.length;d++)b[d]();
...
b("search")+b("hash")}}function g(b,d,g){var l={},m={};b=h(b,l,m);if(null!=d){for(var z in d)l[z]=d[z];b=b.replace(/:([^\/]+)/g,function(a,b){delete l[b];return d[b]})}(z=L(l))&&(b+="?"+z);(m=L(m))&&(b+="#"+m);k?(g&&g.replace?a.history.replaceState(null,null,e+b):a.history.pushState(null,null,e+b),a.onpopstate()):a.location.href=e+b}var k="function"===typeof a.history.pushState,l="function"===typeof setImmediate?setImmediate:setTimeout,e="#!";return{setPrefix:function(a){e=a},getPath:d,setPath:g,
defineRoutes:function(b,g,r){function p(){var a=d(),e={},k=h(a,e,e);l(function(){for(var d in b){var h=new RegExp("^"+d.replace(/:[^\/]+?\.{3}/g,"(.*?)").replace(/:[^\/]+/g,"([^\\/]+)")+"/?$");if(h.test(k)){k.replace(h,function(){for(var h=d.match(/:[^\/]+/g)||[],k=[].slice.call(arguments,1,-2),l=0;l<h.length;l++)e[h[l].replace(/:|\./g,"")]=decodeURIComponent(k[l]);g(b[d],e,a,d)});return}}r(a,e)})}k?a.onpopstate=p:"#"===e.charAt(0)&&(a.onhashchange=p);p();return p},link:function(a){a.dom.setAttribute("href",
...
return a.redraw=d};l.route=function(a,b,h){var d=ka(a);a=function(a,k,l){var e=null,n=null;l=d.defineRoutes(l,function(d,h,k,l){if("function"!==typeof d.view){"function"!==typeof d.render&&(d.render=function(a){return a});var m=function(l){e=k;n=l;b.render(a,d.render(r(l,null,h,void 0,void 0,void 0)))};"function"!==typeof d.resolve&&(d.resolve=function(){m(n)});k!==e?d.resolve(m,h,k,l):m(n)}else b.render(a,r(d,null,h,void 0,void 0,void 0))},function(){d.setPath(k,null,{replace:!0})});Z(a,b,h,l)};
a.link=d.link;a.prefix=d.setPrefix;a.set=d.setPath;a.get=d.getPath;return a}(window,K,H);l.mount=function(a,b){return function(h,d){Z(h,a,b,function(){a.render(h,r(d,void 0,{},[],void 0,void 0))})()}}(K,H);l.trust=function(a){return r("<",void 0,void 0,a,void 0,void 0)};l.withAttr=function(a,b,h){return function(d){return b.call(h||this,a in d.currentTarget?d.currentTarget[a]:d.currentTarget.getAttribute(a))}};l.prop=C.stream;l.prop.combine=C.combine;l.prop.reject=C.reject;l.prop.merge=C.merge;l.prop.HALT=
C.HALT;l.render=K.render;l.redraw=H.publish;l.request=M.xhr;l.jsonp=M.jsonp;l.version="1.0.0";"undefined"!==typeof module?module.exports=l:window.m=l};