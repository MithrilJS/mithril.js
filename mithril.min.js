...
!1,a=this.getAttribute("href"),0===a.indexOf(q)&&(a=a.slice(q.length)),f(a,void 0,void 0))}}}};y.route=function(a,c){var h=Q(a),g=function(a){return a},d={},f=function(a,f,q){if(null==a)throw Error("Ensure the DOM element that was passed to `m.route` is not undefined");var n=function(a,c,f,h){d={resolver:a,component:c,params:f,path:h,resolve:null};d.resolver.render=a.render||g;l()},l=function(){c.render(a,d.resolver.render(m(d.component,d.params.key,d.params)))};h.defineRoutes(q,function(a,c,f){a.view?
n({},a,c,f):a.onmatch?null!=d.resolve?n(a,d.component,c,f):(d.resolve=function(b){n(a,b,c,f)},a.onmatch(function(a){null!=d.resolve&&d.resolve(a)},c,f)):n(a,"div",c,f)},function(){h.setPath(f)});c.subscribe(a,l)};f.set=h.setPath;f.get=function(){return d.path};f.prefix=h.setPrefix;f.link=h.link;return f}(window,H);y.withAttr=function(a,c,h){return function(g){return c.call(h||this,a in g.currentTarget?g.currentTarget[a]:g.currentTarget.getAttribute(a))}};var R=N(window);y.render=R.render;y.redraw=
H.redraw;y.request=J.request;y.jsonp=J.jsonp;y.parseQueryString=K;y.buildQueryString=C;y.version="1.0.0-rc.6";"undefined"!==typeof module?module.exports=y:window.m=y};