...
In a case of 404 Not Found error, Express or similar send back the custom page to client. When Mithril is loaded, it will redirect client to the default route because it can't know that route.
