...
o.spec("hyperscript", function() {
	o.spec("selector", function() {
		...
		o("handles class in selector", function() {
			...
			o(vnode.m & m.TYPE_MASK).equals(m.TYPE_ELEMENT)
			o(vnode.t).equals(".a")
			o(vnode.a.class).equals("a")
		})
		o("handles many classes in selector", function() {
			var vnode = m(".a.b.c")

			o(vnode.m & m.TYPE_MASK).equals(m.TYPE_ELEMENT)
			o(vnode.t).equals(".a.b.c")
			o(vnode.a.class).equals("a b c")
		})
		o("handles id in selector", function() {
			...
			o(vnode.m & m.TYPE_MASK).equals(m.TYPE_ELEMENT)
			o(vnode.t).equals("#a")
			o(vnode.a.id).equals("a")
		})
		o("handles attr in selector", function() {
			var vnode = m("[a=b]")

			o(vnode.m & m.TYPE_MASK).equals(m.TYPE_ELEMENT)
			o(vnode.t).equals("[a=b]")
		...
		o("handles many attrs in selector", function() {
			...
			o(vnode.m & m.TYPE_MASK).equals(m.TYPE_ELEMENT)
			o(vnode.t).equals("[a=b][c=d]")
			o(vnode.a.a).equals("b")
			o(vnode.a.c).equals("d")
		})
		...
		o("handles attr w/ quoted square bracket", function() {
			...
			o(vnode.m & m.TYPE_MASK).equals(m.TYPE_ELEMENT)
			o(vnode.t).equals("[x][a='[b]'].c")
			o(vnode.a.x).equals(true)
			o(vnode.a.a).equals("[b]")
			o(vnode.a.class).equals("c")
		})
		o("handles attr w/ unmatched square bracket", function() {
			var vnode = m("[a=']'].c")

			o(vnode.m & m.TYPE_MASK).equals(m.TYPE_ELEMENT)
			o(vnode.t).equals("[a=']'].c")
			o(vnode.a.a).equals("]")
			o(vnode.a.class).equals("c")
		})
		...
		o("handles tag, mixed classes, attrs in selector", function() {
			...
			o(vnode.m & m.TYPE_MASK).equals(m.TYPE_ELEMENT)
			o(vnode.t).equals("a.b[c = 'd'].e[f = 'g']")
			o(vnode.a.class).equals("b e")
			o(vnode.a.c).equals("d")
			o(vnode.a.f).equals("g")
		})
	...
	o.spec("custom element attrs", function() {
		o("handles string attr", function() {
			...
			o(vnode.m & m.TYPE_MASK).equals(m.TYPE_ELEMENT)
			o(vnode.t).equals("custom-element")
			o(vnode.a.a).equals("b")
		})
		o("handles falsy string attr", function() {
		...
		o("casts className using toString like browsers", function() {
			...
			o(vnode.a.class).equals("valueOf toString")
		})
	})
	...
	o.spec("permutations", function() {
		o("handles null attr and children", function() {
			...
			o(vnode.c[0].m & m.TYPE_MASK).equals(m.TYPE_ELEMENT)
			o(vnode.c[0].t).equals("a")
			o(vnode.c[1].m & m.TYPE_MASK).equals(m.TYPE_ELEMENT)
			o(vnode.c[1].t).equals("b")
		})
		...
		o("handles attr and children", function() {
			...
			o(vnode.a.a).equals("b")
			o(vnode.c[0].m & m.TYPE_MASK).equals(m.TYPE_ELEMENT)
			o(vnode.c[0].t).equals("i")
			o(vnode.c[1].m & m.TYPE_MASK).equals(m.TYPE_ELEMENT)
			o(vnode.c[1].t).equals("s")
		})
		...
		o("handles shared attrs", function() {
			...
			o(nodeA.a.class).equals("a")
			o(nodeA.a.a).equals("b")

			o(nodeB.a.class).equals("b")
			o(nodeB.a.a).equals("b")
		})
		...
		o("non-nullish attr takes precedence over selector", function() {
			o(m("[a=b]", {a: "c"}).a).deepEquals({a: "c"})
		})
		o("null attr takes precedence over selector", function() {
			o(m("[a=b]", {a: null}).a).deepEquals({a: null})
		})
		o("undefined attr takes precedence over selector", function() {
			o(m("[a=b]", {a: undefined}).a).deepEquals({a: undefined})
		})
		o("handles fragment children without attr unwrapped", function() {
			var vnode = m("div", [m("i")], [m("s")])

			o(vnode.c[0].m & m.TYPE_MASK).equals(m.TYPE_FRAGMENT)
			o(vnode.c[0].c[0].m & m.TYPE_MASK).equals(m.TYPE_ELEMENT)
			o(vnode.c[0].c[0].t).equals("i")
			o(vnode.c[1].m & m.TYPE_MASK).equals(m.TYPE_FRAGMENT)
			o(vnode.c[1].c[0].m & m.TYPE_MASK).equals(m.TYPE_ELEMENT)
			o(vnode.c[1].c[0].t).equals("s")
		})
		o("handles children with nested array", function() {
			...
			o(vnode.c[0].c[0].m & m.TYPE_MASK).equals(m.TYPE_ELEMENT)
			o(vnode.c[0].c[0].t).equals("i")
			o(vnode.c[0].c[1].m & m.TYPE_MASK).equals(m.TYPE_ELEMENT)
			o(vnode.c[0].c[1].t).equals("s")
		})
		o("handles children with deeply nested array", function() {
			var vnode = m("div", [[[m("i"), m("s")]]])

			o(vnode.c[0].m & m.TYPE_MASK).equals(m.TYPE_FRAGMENT)
			o(vnode.c[0].c[0].m & m.TYPE_MASK).equals(m.TYPE_FRAGMENT)
			o(vnode.c[0].c[0].c[0].m & m.TYPE_MASK).equals(m.TYPE_ELEMENT)
			o(vnode.c[0].c[0].c[0].t).equals("i")
			o(vnode.c[0].c[0].c[1].m & m.TYPE_MASK).equals(m.TYPE_ELEMENT)
			o(vnode.c[0].c[0].c[1].t).equals("s")
		})
	})
	o.spec("components", function() {
		o("works with constructibles", function() {
			...
			o(vnode.m & m.TYPE_MASK).equals(m.TYPE_COMPONENT)
			o(vnode.t).equals(component)
			o(vnode.a.id).equals("a")
			o(vnode.a.children.length).equals(1)
			o(vnode.a.children[0]).equals("b")
		})
