...
Despite the huge improvements in performance and modularity, the new codebase is smaller than v0.2.x, currently clocking at <!-- size-core -->7.41 KB<!-- /size --> min+gzip (<!-- size-full -->8.22 KB<!-- /size --> min+gzip with [`m.stream`](docs/stream.md))
