...
A modern client-side Javascript framework for building Single Page Applications. It's small (<!-- size -->8.25 KB<!-- /size --> gzipped), fast and provides routing and XHR utilities out of the box.
